...
int main() {
    int n = 0; // Initialize employee count
    char continueInput; // Variable to store user's choice
    int id_num;
    ...
    // After exiting the loop, calculate and print total payroll and average
    if (n > 0) {
